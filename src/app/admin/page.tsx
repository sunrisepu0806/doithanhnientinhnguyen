        ...
        <div className="max-w-7xl mx-auto px-6 -mt-16 relative z-20">
          <div className="bg-white/95 backdrop-blur-2xl p-6 lg:p-8 rounded-[3.5rem] shadow-2xl shadow-blue-900/10 border-4 border-white flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <button
              ...
              className="w-full md:w-auto py-5 px-10 bg-[#0055A5] text-white font-black rounded-[2.5rem] shadow-xl hover:shadow-blue-300 hover:bg-[#0047AB] transition-all flex items-center justify-center gap-3 active:scale-95"
            >
